...
# RDN BI model (x2)
#python3.6 main.py --scale 2 --save RDN_D16C8G64_BIx2 --model RDN --epochs 200 --batch_size 2 --data_range 801-805 --patch_size 64 --reset
# RDN BI model (x3)
#python3.6 main.py --scale 3 --save RDN_D16C8G64_BIx3 --model RDN --epochs 200 --batch_size 2 --data_range 801-805 --patch_size 96 --reset
# RDN BI model (x4)
#python3.6 main.py --scale 4 --save RDN_D16C8G64_BIx4 --model RDN --epochs 200 --batch_size 2 --data_range 801-805 --patch_size 128 --reset
...
# sp Train 
# train # python main.py --model EDSR --scale 2 --patch_size 96 --save edsr_baseline_x2 --reset

# test
# python main.py --model EDSR --data_test Set5+Set14+B100+Urban100 --scale 2 --pre_train ../experiment/edsr_baseline_1110/model/model_best.pt --test_only --self_ensemble --save_results

# python main.py --model SRCNN --data_test Set5+Set14+B100+Urban100 --scale 2 --pre_train ../experiment/spexp0001/model/model_best.pt --test_only --self_ensemble --save_results


# 关于 DataSet 的控制见 data.__init__


# python main.py --model SRCNN --scale 2 --data_test Set5+Set14+B100+Urban100 --pre_train ../experiment/srcnn01173/model/model_best.pt --test_only --self_ensemble --save_results